...
# 读取数据集图像，将其分组并调用imgs2pickle函数将其保存为pickle格式
...
# 读取整个数据集的图像，将其分组并调用imgs2pickle函数进行处理
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input_path', default='E:\HKU\HKU_Sem2\COMP 7404\Project\GaitDatasetB-silh\extract', type=str, help='Root path of raw dataset.')
    parser.add_argument('-o', '--output_path', default='E:\HKU\HKU_Sem2\COMP 7404\Project\GaitDatasetB-silh\CASIA-B-processed', type=str, help='Output path of pickled dataset.')
